...
export class ActivitiesPageComponent implements OnInit {
  ...
  constructor(private dataServiceLastActivity: LsActivityService, private toastr: ToastrService, private dataActivities: ActivityDataService) { 
  ...
  test() {
    console.log(this.dataServiceLastActivity.activity)
  }
  ...
  reloadActivities() {
    ...
    this.dataServiceLastActivity.activity = this.activities.length;
